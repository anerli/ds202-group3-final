...
<!-- Start of Murat --->
# Effects of Weather Conditions on Accidents
...
First, lets make a frequency table for the variable severity. Table shows us that mode of the variable severity is 2. We can say there are few severity factors of 1 and 4 but 4 is being more common than 1.
...
Our histogram shows that reported temperature at 0 degrees Fahrenheit, there are few accidents since this weather is not very common in the US.

As the temperature starts to increase, the number of accidents also increase mainly because there are more people out when it is warmer. When the temperature increase from there, accidents starts going down since less people are out due to weather being too hot
...
Finally lets look the weather conditions by severity. There are many different weather conditions reported but we are going to only visualize the ones which caused more than 100 accidents.
...
As our analysis shows, we conclude that weather condition does not have a strong impact on accident severity.
...
Ryan: I focused my analysis on looking at car accidents amoung men and women. I compared the totals from different ages of men and women, as well as comparing the totals amoung men and women by the different days of the week. I also worked on the presentation and team report.
